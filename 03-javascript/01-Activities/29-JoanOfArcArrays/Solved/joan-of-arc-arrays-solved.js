...
const joanOfArcInfoParts = ["Real Name", "Grew Up Where", "Known For", "Scars", "Symbolism"];

// Values for Joan's "properties."
const joanOfArcInfoValues = [
  "Jehanne la Pucelle.",
...
const input = "Real Name";

// How do I use input to get "Jehanne la Pucelle."
const index = joanOfArcInfoParts.indexOf(input);
const valuesIndex = joanOfArcInfoValues[index];
