const stockPrices = [1.32, 1.14, 1.45, 1.20, 1.34, 1.74, 1.18, 1.90, 1.1];

const biggestProfit = function(stockArray, sharesBought) {
  ...
  if (stockArray.length > 2) {
    ...
    let maxProfit = stockArray[1] - stockArray[0];
